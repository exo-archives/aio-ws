...
2. Building.
   2.1. Compile project 'connector30' and put 'exo.ws.rest.ejbconnector30.client30-jonas-trunk.jar'
     into directory $JONAS_BASE/easybeans-deploy.
     
     './jonas admin -j'
     You should see your bean in the list.
     
   2.2. Compile 'simple-service' and put 'exo.ws.simple.rest.service-${org.exoplatform.ws.version}.jar' in lib directory of jonas.
