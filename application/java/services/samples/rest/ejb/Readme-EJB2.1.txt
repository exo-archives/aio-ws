...
1. Compile project 'connector21' and put 'exo.ws.rest.ejbconnector21-${org.exoplatform.ws.version}.jar' in
   JONAS_ROOT/ejbjars and deploy it by command:
   
     './jonas admin -a exo.ws.application.ejbconnector21-${org.exoplatform.ws.version}.jar'
     './jonas admin -j'
