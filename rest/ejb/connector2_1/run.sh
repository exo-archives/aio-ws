...
-cp $JONAS_ROOT/lib/apps/exo.core.component.security.core-2.1.4-SNAPSHOT.jar:\
$JONAS_ROOT/lib/apps/exo.ws.commons-1.3.2-SNAPSHOT.jar:$JONAS_ROOT/lib/client.jar \
