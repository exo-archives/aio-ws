...
-cp \
../connector/target/exo.ws.rest.ejbconnector3_0.bean-2.0.2.jar:\
$JONAS_ROOT/lib/apps/exo.core.component.security.core-2.2.2.jar:\
$JONAS_ROOT/lib/apps/exo.ws.rest.core-2.0.2.jar:\
$JONAS_ROOT/lib/apps/exo.ws.rest.ext-2.0.2.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.ws.rest.ejbconnector3_0.client-2.0.2.jar
