...
-cp \
../connector/target/exo.ws.rest.ejbconnector3_0.bean-$VERSION.jar:\
$JONAS_ROOT/lib/apps/exo.core.component.security.core-2.1.2.jar:\
$JONAS_ROOT/lib/apps/exo.ws.commons-$VERSION.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.ws.rest.ejbconnector3_0.client-$VERSION.jar
