...
-cp \
../connector/target/exo.ws.rest.ejbconnector3_0.bean-2.0-SNAPSHOT.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.ws.rest.ejbconnector3_0.client-2.0-SNAPSHOT.jar
