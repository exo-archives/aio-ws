...
-cp \
../connector/target/exo.ws.rest.ejbconnector3_0.bean-1.3.4-SNAPSHOT.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.ws.rest.ejbconnector3_0.client-1.3.4-SNAPSHOT.jar
