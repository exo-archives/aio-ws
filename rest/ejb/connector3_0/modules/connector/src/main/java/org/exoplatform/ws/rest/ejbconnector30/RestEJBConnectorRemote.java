...
public interface RestEJBConnectorRemote {
  ...
  /**
   * @param request SerialRequest. This is special wrapper around REST request,
   *          which can be transfer via RMI.
   * @return SerialResponse. This is special wrapper for REST response, which
   *         can be transfer via RMI.
