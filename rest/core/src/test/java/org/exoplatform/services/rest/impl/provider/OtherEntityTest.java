...
//    h.putSingle("content-type", "application/octet-stream");
  ...
  public static class Resource2 {
    ...
    public DOMSource m5() throws Exception {
      return new DOMSource(DocumentBuilderFactory.newInstance()
                                                 .newDocumentBuilder()
                                                 .parse(new ByteArrayInputStream(XML_DATA.getBytes("UTF-8"))));
    }
    ...
    public Response m9() throws Exception {
      ...
      return Response.ok(data, "text/plain").header(HttpHeaders.CONTENT_LENGTH,
                                                    data.getBytes("UTF-8").length).build();
    }
  }
  ...
  public void testReturn() throws Exception {
    ...
    assertEquals("to be or not to be".getBytes("UTF-8").length + "",
                 response.getHttpHeaders().getFirst(HttpHeaders.CONTENT_LENGTH).toString());
