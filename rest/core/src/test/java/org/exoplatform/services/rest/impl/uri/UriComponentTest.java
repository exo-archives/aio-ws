...
public class UriComponentTest extends BaseTest {
  ...
  public void testRecognizeEncoding() {
    ...
    assertEquals("to%20be%2523or%20not%20to%2520be",
                 UriComponent.encode(str, UriComponent.PATH_SEGMENT, false));
    // no double encoding here
    assertEquals("to%20be%23or%20not%20to%20be",
                 UriComponent.recognizeEncode(str, UriComponent.PATH_SEGMENT, false));
  }
