...
public class ResponseFilterTest extends AbstractResourceTest {
  ...
  public static class ResponseFilter1 implements ResponseFilter {
    ...
    public ResponseFilter1(@Context Providers providers,
    ...
    public void doFilter(GenericContainerResponse response) {
      if (uriInfo != null && httpHeaders != null && providers != null && httpRequest != null
          && binder != null)
        response.setResponse(Response.status(200)
                                     .entity("to be or not to be")
                                     .type("text/plain")
                                     .build());
    }
  ...
  public static class ResponseFilter2 implements ResponseFilter {
    ...
    public void doFilter(GenericContainerResponse response) {
      response.setResponse(Response.status(response.getStatus())
