...
public class MatchedURIsAndResourcesTest extends AbstractResourceTest {
  ...
  public void testLevel1() throws Exception {
    ...
    registry(r1);
    assertEquals("/1,/a/b", service("GET",
                                    "http://localhost/test/a/b/1",
                                    "http://localhost/test",
                                    null,
                                    null).getEntity());
    assertEquals("Resource1", service("GET",
  ...
  public void testLevel2() throws Exception {
    Resource1 r1 = new Resource1();
    registry(r1);
    assertEquals("/1,/sub,/a/b", service("GET",
                                       "http://localhost/test/a/b/sub/1",
                                       "http://localhost/test",
                                       null,
                                       null).getEntity());
    assertEquals("SubResource1,Resource1", service("GET",
                                                   "http://localhost/test/a/b/sub/2",
                                                   "http://localhost/test",
                                                   null,
                                                   null).getEntity());
    unregistry(r1);
  ...
  public void testLevel3() throws Exception {
    Resource1 r1 = new Resource1();
    registry(r1);
    assertEquals("/1,/sub-sub,/sub,/a/b", service("GET",
                                       "http://localhost/test/a/b/sub/sub-sub/1",
                                       "http://localhost/test",
                                       null,
                                       null).getEntity());
    assertEquals("SubResource2,SubResource1,Resource1", service("GET",
