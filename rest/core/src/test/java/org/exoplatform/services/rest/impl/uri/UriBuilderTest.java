...
public class UriBuilderTest extends BaseTest {
  ...
  public void testReplaceSchemeSpecificPart() {
    URI u = UriBuilder.fromUri("http://localhost:8080/a/b/c")
                       .schemeSpecificPart("//localhost:8080/a/b/c/d")
                       .build();
  ...
  public void testReplaceNatrixParam() {
    URI u = UriBuilder.fromUri("http://localhost:8080/a/b/c;a=x;b=y;a=z")
                      .replaceMatrixParam("a", "b", "c")
                      .build();
    assertEquals(URI.create("http://localhost:8080/a/b/c;b=y;a=b;a=c"), u);
    u = UriBuilder.fromUri("http://localhost:8080/a/b/c;y=b;a=x;b=y;a=z")
                  .replaceMatrixParam("a", "b", "c")
                  .build();
  ...
  public void testReplaceMatrixParams() {
    URI u = UriBuilder.fromUri("http://localhost:8080/a/b/c;a=x;b=y")
  ...
  public void testReplaceQueryParam() {
    URI u = UriBuilder.fromUri("http://localhost:8080/a/b/c?a=x&b=y&a=z")
                      .replaceQueryParam("a", "b", "c")
                      .build();
    assertEquals(URI.create("http://localhost:8080/a/b/c?b=y&a=b&a=c"), u);
    u = UriBuilder.fromUri("http://localhost:8080/a/b/c?a=x&a=z&b=y")
                  .replaceQueryParam("a", "b", "c")
                  .build();
    assertEquals(URI.create("http://localhost:8080/a/b/c?b=y&a=b&a=c"), u);
    u = UriBuilder.fromUri("http://localhost:8080/a/b/c?b=y&a=x&y=b&a=z")
                  .replaceQueryParam("a", "b%20", "c%")
                  .build();
  ...
  public void testReplaceQuery() {
    URI u = UriBuilder.fromUri("http://localhost:8080/a/b/c?a=x&b=y")
                       .replaceQuery("x=a&y=b&zzz=")
                       .build();
    assertEquals(URI.create("http://localhost:8080/a/b/c?x=a&y=b&zzz"), u);
    u = UriBuilder.fromUri("http://localhost:8080/a/b/c?a=x&b=y")
                  .replaceQuery("x=a&zzz=&y=b")
                  .build();
  ...
  public void testReplaceFragment() {
    URI u = UriBuilder.fromUri("http://localhost:8080/a/b/c?a=x&b=y#hi")
                       .fragment("hel lo")
                       .build();
  ...
  public void testAppendPathAndMatrixParams() {
    URI u = UriBuilder.fromUri("http://localhost:8080/")
                       .path("a")
                       .matrixParam("x", " foo")
                       .matrixParam("y", "%20bar")
                       .path("b")
  ...
  public void testTemplates() {
    ...
    m.put("bar", "%y");
    m.put("baz", "z");
    u = UriBuilder.fromUri("http://localhost:8080/a/b/c")
                  .path("/{foo}/{bar}/{baz}/{foo}")
                  .buildFromMap(m);
    assertEquals(URI.create("http://localhost:8080/a/b/c/%2525x/%25y/z/%2525x"), u);
    ...
    u = UriBuilder.fromUri("http://localhost:8080/a/b/c")
                  .path("/{foo}/{bar}/{baz}/{foo}")
                  .buildFromEncoded("%25x", "%y", "z", "wrong");
