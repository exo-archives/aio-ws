 ...
 * @version $Id: $
 */
public class ResourceContainerQueryTemplateFail implements ResourceContainer {

  @HTTPMethod("GET")
  @URITemplate("/test/qeuryfilter/")
  @QueryTemplate("method=method1")
// @QueryTemplate("method=method2")
// @QueryTemplate("method=method3")
// @QueryTemplate("method=method1&param1=param1")
// @QueryTemplate("method=method3&param3=param3")
