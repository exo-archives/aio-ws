...
public abstract class ParameterResolver<T> {
   ...
   * instance of {@link MethodParameter#getParameterClass()}.
   * 
   * @param parameter See {@link MethodParameter}
   * @param context See {@link ApplicationContext}
   * @return newly created instance of class
   *         {@link MethodParameter#getParameterClass()}
   * @throws Exception if any errors occurs
   */
  public abstract Object resolve(MethodParameter parameter, ApplicationContext context) throws Exception;
