...
public final class VariantsHandler {
  ...
  public static Variant handleVariants(ContainerRequest r, List<Variant> variants) {
    ...
    List<AcceptMediaType> m = HeaderHelper.createAcceptedMediaTypeList(
        HeaderHelper.convertToString(r.getRequestHeader(ContainerRequest.ACCEPT)));
    
    // create quality sorted list of accept encoding
    List<AcceptLanguage> l = HeaderHelper.createAcceptedLanguageList(
        HeaderHelper.convertToString(r.getRequestHeader(ContainerRequest.ACCEPT_LANGUAGE)));
    
    // create quality sorted list of accept encoding
    List<AcceptToken> c = HeaderHelper.createAcceptedCharsetList(
        HeaderHelper.convertToString(r.getRequestHeader(ContainerRequest.ACCEPT_CHARSET)));
    
    // create quality sorted list of accept encoding
    List<AcceptToken> e = HeaderHelper.createAcceptedEncodingList(
        HeaderHelper.convertToString(r.getRequestHeader(ContainerRequest.ACCEPT_ENCODING)));
   ...
   */
  private static <T extends QualityValue, V> void handleVariants(List<T> accept,
