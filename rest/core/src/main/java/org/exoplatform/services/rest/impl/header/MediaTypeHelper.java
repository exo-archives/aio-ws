...
public final class MediaTypeHelper {
  ...
  public static final Comparator<MediaType> MEDIA_TYPE_COMPARATOR = new Comparator<MediaType>() {
    ...
    public int compare(MediaType o1, MediaType o2) {
      if (o1.getType().equals(MediaType.MEDIA_TYPE_WILDCARD)
          && !o2.getType().equals(MediaType.MEDIA_TYPE_WILDCARD)) {
        return 1;
      }
   ...
   * WADL media type.
   */
  public static final MediaType             WADL_TYPE             = new MediaType("application",
                                                                                  "vnd.sun.wadl+xml");
