...
public interface HTTPClientModule extends HTTPClientModuleConstants {
   ...
   *              the request
   */
  public int requestHandler(Request request, Response[] response) throws IOException,
      ModuleException;
   ...
   *              the response
   */
  public void responsePhase1Handler(Response response, RoRequest request) throws IOException,
      ModuleException;
   ...
   *              the response
   */
  public void responsePhase3Handler(Response response, RoRequest request) throws IOException,
      ModuleException;
   ...
   *              the trailers
   */
  public void trailerHandler(Response response, RoRequest request) throws IOException,
      ModuleException;
}
