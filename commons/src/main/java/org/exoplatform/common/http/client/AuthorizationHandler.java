...
public interface AuthorizationHandler {
  ...
  AuthorizationInfo fixupAuthInfo(AuthorizationInfo info, RoRequest req,
      AuthorizationInfo challenge, RoResponse resp) throws AuthSchemeNotImplException, IOException;
   ...
   *              headers.
   */
  void handleAuthHeaders(Response resp, RoRequest req, AuthorizationInfo prev,
   ...
   */
  void handleAuthTrailers(Response resp, RoRequest req, AuthorizationInfo prev,
      AuthorizationInfo prxy) throws IOException;
}
