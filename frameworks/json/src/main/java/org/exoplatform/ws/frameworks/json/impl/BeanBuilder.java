    ...
    for (Method method : methods) {
      ...
      if (methodName.startsWith("set") && methodName.length() > "set".length()) {
        ...
        if (JsonUtils.isKnownType(methodParameterClazz)) {
          method.invoke(object, new Object[] { createObjectKnownTypes(methodParameterClazz,
                                                                      childJsonValue) });
        } else {
          ...
          if (type != null) {
            ...
            case COLLECTION: {
              ...
              if (methodParameterClazz.isInterface()
                ...
                try {
                  constructor = ArrayList.class.asSubclass(methodParameterClazz)
                                               .getConstructor(new Class[] { Collection.class });
                } catch (Exception e) {
                  try {
                    constructor = HashSet.class.asSubclass(methodParameterClazz)
                                               .getConstructor(new Class[] { Collection.class });
                  } catch (Exception e1) {
                    try {
                      constructor = LinkedList.class.asSubclass(methodParameterClazz)
                                                    .getConstructor(new Class[] { Collection.class });
                    } catch (Exception e2) {
            ...
            case MAP: {
              ...
              if (methodParameterClazz.isInterface()
                  || Modifier.isAbstract(methodParameterClazz.getModifiers())) {
                try {
                  constructor = HashMap.class.asSubclass(methodParameterClazz)
                                             .getConstructor(new Class[] { Map.class });
                } catch (Exception e) {
                  try {
                    constructor = Hashtable.class.asSubclass(methodParameterClazz)
                                                 .getConstructor(new Class[] { Map.class });
                  } catch (Exception e1) {
                    try {
                      constructor = LinkedHashMap.class.asSubclass(methodParameterClazz)
                                                       .getConstructor(new Class[] { Map.class });
                    } catch (Exception e2) {
                      // ignore exception here
                    }
