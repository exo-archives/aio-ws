...
// start library "exowebdav" =====================================================================================
/**
 * @classDescription Javascript library eXo WebDAV of gadget 
 * Created by The eXo Platform SAS.
 * @author: <a href="mailto:dmitry.ndp@exoplatform.com.ua">Dmytro Nochevnov</a>
 * @version $Id: $ Dec 25, 2008
 ...
 */
Webdav.prototype.wrapperHandler = function(handler) {
  var self = this;
  function Handler() {
    handler = {
    ...
    this.execute = function(IOResult) {
      var result = self.parseResponse(IOResult);
      self.result = result;
      IOResult = null;
 ...
 * <br />- {Object} <b>result.content</b> = XMLHttp response.text
 */
Webdav.prototype.parseResponse = function(IOResult) {
  return result = {
    status: IOResult.rc,
    statusstring: this.STATUS_CODES[IOResult.rc.toString()],
    headers: IOResult.headers,
    content: IOResult.text
  };
}
...
/**
 * test !!!
 * performs XMLHttp request and sets its header 'Authorization' in case of this.username is not empty
 * @private
 ...
 */
Webdav.prototype.performIORequest = function(path, method, handler, headers, post_data) {
  var params = {};
  ...
  /* prepare a request */
  callback = this.wrapperHandler(handler);
...
Webdav.prototype.ExtensionMethod = function (handler, path, options) {
  ...
  this.performIORequest(path || '', options.method, handler, options.headers, options.body);
}
...
Webdav.prototype.GET = function(handler, path, options) {
  ...
  this.performIORequest(path || '', 'GET', handler, options.headers, null);
};
...
Webdav.prototype.PUT = function(handler, path, options) {
  ...
  this.performIORequest(path || '', 'PUT', handler, options.headers, options.content);
};
...
Webdav.prototype.DELETE = function(handler, path, options) {
  ...
  this.performIORequest(path || '', 'DELETE', handler, options.headers, null);
};
...
Webdav.prototype.OPTIONS = function(handler, path) {
  ...
  this.performIORequest(path || '', 'OPTIONS', handler, options.headers, null);
};
...
Webdav.prototype.MKCOL = function(handler, path, options) {
  ...
  this.performIORequest(path || '', 'MKCOL', handler, options.headers, null);
}
...
Webdav.prototype.COPY = function(handler, path, options) {
  ...
  options.headers['Destination'] = encodeURI(this.url + options.destination);
  ...
  this.performIORequest(path || '', 'COPY', handler, options.headers, null);
};
...
Webdav.prototype.MOVE = function(handler, path, options) {
  ...
  this.performIORequest(path || '', 'MOVE', handler, options.headers, null);
};
...
Webdav.prototype.HEAD = function(handler, path, options) {
  ...
  this.performIORequest(path || '', 'HEAD', handler, options.headers, null);
};
...
Webdav.prototype.PROPFIND = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'PROPFIND', handler, options.headers, xml);
}
...
Webdav.prototype.PROPPATCH = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'PROPPATCH', handler, options.headers, xml);
}
...
Webdav.prototype.LOCK = function (handler, path, options) {
  ...
  options.headers['Content-Type'] = 'text/xml; charset=UTF-8';
  options.headers['Timeout'] = options.timeout;

  if (options.locktoken) {
    options.headers['If'] = '<' + options.locktoken + '>';
  };

  this.performIORequest(path || '', 'LOCK', handler, options.headers, xml);
};
...
Webdav.prototype.UNLOCK = function (handler, path, options) {
  ...
  options.headers['Lock-Token'] = '<' + options.locktoken + '>';

  this.performIORequest(path || '', 'UNLOCK', handler, options.headers, null);
}
...
Webdav.prototype.VERSIONCONTROL = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'VERSIONCONTROL', handler, options.headers, xml);
}
...
Webdav.prototype.CHECKOUT = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'CHECKOUT', handler, options.headers, null);  
}
...
Webdav.prototype.CHECKIN = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'CHECKIN', handler, options.headers, null);
}
...
Webdav.prototype.UNCHECKOUT = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'UNCHECKOUT', handler, options.headers, null);
};
...
Webdav.prototype.REPORT = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'REPORT', handler, options.headers, xml);
}
...
Webdav.prototype.ORDERPATCH = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'ORDERPATCH', handler, options.headers, xml);
};
...
Webdav.prototype.SEARCH = function (handler, path, options) {
  ...
  this.performIORequest(path || '', 'SEARCH', handler, options.headers, xml);
};

var gadgets = gadgets || {};

gadgets.exowebdav = Webdav;

// finish library "exowebdav" ====================================================================================